  ...
  <v-card class="mx-auto">
    ...
    >
      <v-card-title class="text-h5">{{
        `${introductionGroup.cName} ${introductionGroup.eName}`
      }}</v-card-title>
    </v-img>
    ...
    <v-timeline side="end" direction="horizontal">
      <v-timeline-item
        ...
        min-width="30vw"
      >
        <v-alert :color="item.color" :value="true">
          <div>{{ item.year }}</div>
          <div>{{ item.school }}</div>
    ...
    <v-timeline side="end" direction="horizontal">
      <v-timeline-item
        ...
        min-width="30vw"
      >
        <v-alert :color="workItem.color" :value="true">
  ...
  educational: [
    {
      ...
      year: "2015 - 2017",
      school: "國立臺北科技大學",
      department: "資訊與財金管理系 碩士班",
    },
    {
      color: "light-blue-lighten-5",
      year: "2011 - 2015",
      school: "實踐大學",
      department: "資訊科技與管理學系 ",
    },
  ],
  work: [
    {
